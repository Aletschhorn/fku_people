...
/**
 * Test case for class \FKU\FkuPeople\Domain\Model\Subteam.
 *
 ...
 */
class SubteamTest extends \TYPO3\CMS\Core\Tests\UnitTestCase {
	/**
	 * @var \FKU\FkuPeople\Domain\Model\Subteam
	 */
	protected $subject = NULL;

	protected function setUp() {
		$this->subject = new \FKU\FkuPeople\Domain\Model\Subteam();
	}
	...
	public function setTeamForTeamSetsTeam() {
		$teamFixture = new \FKU\FkuPeople\Domain\Model\Team();
